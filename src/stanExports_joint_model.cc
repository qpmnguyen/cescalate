...
#include "stanExports_joint_model.h"

RCPP_MODULE(stan_fit4joint_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_joint_model")
